package com.mywild.whatsdeleted.services
...
import com.mywild.whatsdeleted.BuildConfig
import com.mywild.whatsdeleted.R
import com.mywild.whatsdeleted.utility.isValidApp
...
class NLService : NotificationListenerService() {
    ...
    override fun onCreate() {
        ...
        intentFilter.addAction("com.mywild.whatsdeleted")
    ...
    private fun sendMessage(sbn: StatusBarNotification) {
        val intent = Intent("com.mywild.whatsdeleted")
